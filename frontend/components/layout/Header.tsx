      ...
      >
        <div className="h-full px-3 sm:px-4 lg:px-6">
          <div className="h-full flex items-center justify-between gap-2 sm:gap-3 lg:gap-4 max-w-[1400px] mx-auto">
            ...
            >
              <motion.div
                className="w-9 h-9 sm:w-10 sm:h-10 bg-primary-500 dark:bg-primary-400 rounded-xl flex items-center justify-center shadow-md"
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              {[
                ...
                >
                  <Link
                    href={item.href}
                    className="flex items-center space-x-2 px-3 xl:px-4 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-gray-800 font-medium transition-all duration-300 text-sm xl:text-base"
                  >
                    {item.icon}
                    <span>{item.name}</span>
                  </Link>
            ...
            <div
              ...
              className="relative flex-1 max-w-xs sm:max-w-sm lg:max-w-md xl:max-w-lg"
            >
            ...
            <div className="flex items-center space-x-1 sm:space-x-2 flex-shrink-0">
              ...
              <motion.button
                onClick={toggleTheme}
                className="p-2 text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-gray-800 rounded-full transition-all duration-300"
                whileHover={{
                  scale: 1.05,
