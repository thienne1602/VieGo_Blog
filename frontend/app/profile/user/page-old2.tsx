...
export default function UserProfileNew() {
  ...
  // Fetch data when tab changes (but not on initial mount)
  useEffect(() => {
    if (user && activeTab) {
      fetchTabData();
    }
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20">
      {/* Cover Image */}
      <div className="relative h-80 bg-gradient-to-br from-teal-400 via-blue-500 to-purple-600 overflow-hidden">
        ...
        <div className="bg-white rounded-xl shadow-lg p-6">
          <div className="flex flex-col md:flex-row items-center md:items-end space-y-4 md:space-y-0 md:space-x-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              {(user as any).bio && (
                <p className="mt-2 text-gray-700">{(user as any).bio}</p>
              )}
              ...
              <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-3 text-sm text-gray-600">
                ...
                <div className="flex items-center space-x-1">
                  ...
                  <span>{(user as any).points || 0} điểm</span>
                </div>
              </div>
            </div>
            ...
            {loadingData ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 mb-6">
                  ...
                  {activeTab === "bookmarks" &&
                    "Bắt đầu lưu những bài viết yêu thích"}
                  {activeTab === "likes" &&
                    "Khám phá và thích những bài viết hay"}
                </p>
                {activeTab === "posts" && (
                  <Link href="/posts/create">
                    <motion.button
